...
class EndpointCommercial extends _i1.EndpointRef {
  ...
  @override
  String get name => 'gewerber_commercial.commercial';

  _i2.Future<String> status() => caller.callServerEndpoint<String>(
    'gewerber_commercial.commercial',
    'status',
    {},
  );
}
...
class EndpointWaitlist extends _i1.EndpointRef {
  ...
  @override
  String get name => 'gewerber_commercial.waitlist';

  _i2.Future<void> join(_i3.JoinWaitlistRequest request) =>
      caller.callServerEndpoint<void>(
        'gewerber_commercial.waitlist',
        'join',
        {'request': request},
      );
}
...
class Caller extends _i1.ModuleEndpointCaller {
  ...
  Map<String, _i1.EndpointRef> get endpointRefLookup => {
    'gewerber_commercial.commercial': commercial,
    'gewerber_commercial.waitlist': waitlist,
  };
}
